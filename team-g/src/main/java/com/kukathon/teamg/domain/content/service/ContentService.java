...
public class ContentService {
    ...
    public void updateCheck(Long contentId) {
        Content content = contentRepository.findContentByContentId(contentId).orElseThrow(
                () -> new ApplicationException(CONTENT_NOT_FOUND));
        content.updateCheck();
    }

    public List<CategoryAndContent> findAllContents(Long memberId, DateTime date){
         contentRepository.findAllByMemberIdAndDate(memberId, date);
